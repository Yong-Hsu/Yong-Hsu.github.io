...
function divideTriangle(v1, v2, v3, numSubdivs) {
	...
	pointsArray.push(v12, v23, v2);
	pointsArray.push(v12, v31, v1);
	pointsArray.push(v31, v23, v3);
	pointsArray.push(v12, v23, v31);
	
	if (numSubdivs - 1 != 0) {
		divideTriangle(v12, v23, v2, numSubdivs - 1);
		divideTriangle(v12, v31, v1, numSubdivs - 1);
